...
VALUES (0, 0,'2012-08-14 09:15', 4),
       (1, 1, '2012-05-9 11:15:22', 5),
       (2, 4, '2012-09-10 10:45:25', 3),
       (3, 2, '2012-03-14 15:05:31', 8),
       (4, 0, '2012-09-14 14:45:32', 10),
       (5, 2, '2012-06-11 15:05:48', 4),
       (6, 4, '2012-09-14 15:05:57', 5),
       (7, 1, '2012-03-12 14:45:56', 7),
...
FROM cd.bookings
WHERE cd.bookings.starttime >= '2012-01-01' AND cd.bookings.starttime < '2013-01-01'
